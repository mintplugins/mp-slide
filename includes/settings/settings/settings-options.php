 ...
 * Step 2. Do a find-and-replace for the term 'mp_slide_settings' and replace it with the slug you desire for this page
...
function mp_slide_settings(){
	 ...
	 *
	 */
	$args = array('parent_slug' => 'edit.php?post_type=mp_slide', 'title' => __('Slider Settings', 'mp_core'), 'slug' => 'mp_slide_settings', 'type' => 'submenu');
	
	//Initialize settings class
	global $mp_slide_settings;
	$mp_slide_settings = new MP_CORE_Settings($args);
	
	//Include other option tabs
	include_once( 'settings-tab-general.php' );
	
}
add_action('plugins_loaded', 'mp_slide_settings');